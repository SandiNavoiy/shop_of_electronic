...
class Retail_network(models.Model):
    ...
    contacts = models.ForeignKey(Link, verbose_name='Контакты', on_delete=models.CASCADE)  # Контакты продавца
    ...
    release_date = models.DateField(auto_now_add=True, verbose_name='Дата регистрации звена продажи', **NULLABLE)
